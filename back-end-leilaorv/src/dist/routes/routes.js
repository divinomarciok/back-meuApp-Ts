...
const createProduct2_1 = require("../controllers/createProduct2");
...
router.post('/createcategory', authenticateToken_1.authenticateToken, createCategory_1.createCategory);
...
router.post('/createproduct2', uploadImageProduct_1.upload.single('file'), authenticateToken_1.authenticateToken, validateProduct_1.validateProduct, createProduct2_1.createproduct2);
