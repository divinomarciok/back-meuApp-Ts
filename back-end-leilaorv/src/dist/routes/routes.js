...
router.post('/createproduct2', authenticateToken_1.authenticateToken, uploadImageProduct_1.upload.single('file'), validateProduct_1.validateProduct, createProduct2_1.createproduct2);
